...
CREATE TABLE `logs` (
  ...
  `fan_speed` double DEFAULT NULL,
  `case_temperature` double DEFAULT NULL,
  `vrm_temperature` double DEFAULT NULL,
...
(1,57,44,77,0,37.75,43,'2023-06-19 21:12:02');
...
-- Dump completed on 2023-06-19 21:14:10
